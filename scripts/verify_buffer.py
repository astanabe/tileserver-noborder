...
Reference tip: lon=148.77488, lat=45.55752 (northernmost vertex of the
hoppo dataset, geojson/hoppo.geojson — near Cape Kamui on Etorofu).
1 deg latitude ~ 111 km, so +0.009 deg ~ 1 km, +0.027 deg ~ 3 km.
...
if __name__ == "__main__":
    ...
    print(f"1km north of Etorofu (expect inside buffer) : {'PASS' if inside_1km  else 'FAIL'}")
    print(f"3km north of Etorofu (expect outside buffer): {'PASS' if outside_3km else 'FAIL'}")
